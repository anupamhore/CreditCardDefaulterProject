...
class DBOperations:
    ...
    def connectCassandra(self):
        ...
        """
        try:
            f = open("Training_Logs/dbOperations.txt", 'a+')
        ...
        try:
            ...
            for keyspace in keyspaces_list:
                if keyspace == 'anupam':
                    ...
                    for table in tables:
                        if table == tableName.lower():
                            self.logger.log(f,"Table already created in Cassandra Keyspace!!!")
                            break
                        else:
                            self.logger.log(f, "Table Creation started in Cassandra keyspace!!!")
    ...
    def insertDataIntoTable(self,tableName,column_names):
        ...
        try:
            log_file = open("Training_Logs/dbOperations.txt", 'a+')
